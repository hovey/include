...
% Cavitation
\newcommand{\Pcav}{\mbox{\textsf P}_{\textsf{cav}}}
\newcommand{\Pcavprime}{\overset{\circ}{\mbox{\textsf P}}_{\textsf{cav}}}
\newcommand{\Pcutprime}{\overset{\circ}{\mbox{\textsf P}}_{\textsf{cut}}}
...
\definecolor{hlightgray}{rgb}{0.9,0.9,0.9}
...
\newenvironment{Hexample}[1]
 {
  ...
  %\begin{center}
    %\fbox{\parbox[b]{0.9\linewidth}{
      ...
      \noindent {\colorbox{hlightgray}{\parbox{\linewidth}{\bf Example \theHexamplectr}}} \\ #1 \\
...
% % *-----------------------------*
% % | HOVEY'S Hhighlight ENVIRONMENT |
% % *-----------------------------*---------------------------------
% 
\newenvironment{Hhighlight}
{  % beginning code
  \medskip
  \color{red}
  \noindent{\bf Remark}
